...
SWAGGER_SETTINGS = {
    ...
    'OPERATIONS_SORTER': {'order': 'alpha'},
    'TAGS_SORTER': {'order': 'alpha'},
    'DOC_EXPANSION': 'none',
    'DEEP_LINKING': True,
...
URL_SHORTENER = {
    ...
    'HASHIDS_SALT': config('HASHIDS_SALT', default='url-shortener-salt'),
    'HASHIDS_MIN_LENGTH': config('HASHIDS_MIN_LENGTH', default=6, cast=int),
} 